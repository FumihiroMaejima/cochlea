...
class ServiceTermsRepository implements ServiceTermsRepositoryInterface
{
    protected ServiceTerms $model;
     ...
     * create instance.
     *
     * @param \App\Models\Masters\ServiceTerms $model
     * @return void
     */
    public function __construct(ServiceTerms $model)
    {
        $this->model = $model;
    }
    ...
    public function getRecords(): Collection
    {
        ...
        return DB::table($coins)
            ->select(['*'])
            ->where(ServiceTerms::DELETED_AT, '=', null)
            ->get();
    }
    ...
    public function getRecordList(): Collection
    {
        ...
        // collection
        return DB::table($coins)
            ->select([ServiceTerms::ID, ServiceTerms::TERMS, ServiceTerms::PRIVACY_POLICY])
            ->where(ServiceTerms::DELETED_AT, '=', null)
            ->get();
    }
