...
class BannersServiceTest extends AdminServiceBaseTestCase
{
    ...
    public function testCreateBannerSuccess(
        ...
        $response = $this->json('POST', route('admin.banners.create'), [
            ...
            BannerBaseRequest::KEY_PC_HEIGHT => $pc_height,
            BannerBaseRequest::KEY_PC_WIDTH  => $pc_width,
            BannerBaseRequest::KEY_SP_HEIGHT => $sp_height,
            BannerBaseRequest::KEY_SP_WIDTH  => $sp_width,
            BannerBaseRequest::KEY_START_AT  => $start_at,
            BannerBaseRequest::KEY_END_AT    => $end_at,
